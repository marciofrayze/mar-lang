...
var (
	...
	keywordHoverDescriptions = map[string]string{
		...
		"belongs_to":                              "Declares a singular relationship to another entity. Example: `belongs_to User`, `belongs_to customer: User optional`, or `belongs_to current_user`.",
		"current_user":                            "Used in `belongs_to current_user` to create a required relationship to the authenticated built-in `User` automatically.",
