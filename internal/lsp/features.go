...
var (
	...
	keywordHoverDescriptions = map[string]string{
		...
		"sqlite_busy_timeout_ms":       "Sets SQLite busy timeout in milliseconds. Example: `sqlite_busy_timeout_ms 5000`.",
		"sqlite_wal_autocheckpoint":    "Sets SQLite WAL auto-checkpoint size in pages. Example: `sqlite_wal_autocheckpoint 1000`.",
		"sqlite_journal_size_limit_mb": "Sets SQLite journal size limit in megabytes. Example: `sqlite_journal_size_limit_mb 64`.",
